  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-8">
      <DeviceFrameset device="iPhone X" zoom={0.8}>
        <div className="h-full bg-gray-50 relative overflow-hidden -z-20">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 flex-wrap">
                {["$50", "$100", "$200", "Other"].map((amount) => (
                  <button
                    key={amount}
                    className="px-4 py-2 bg-white border-2 rounded-full font-medium transition-colors hover:text-white"
                    style={{
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white border-t pb-4">
