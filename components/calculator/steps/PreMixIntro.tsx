  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-16rem)]">
      <TextDisplay
        ...
        content="Australian Super's Pre-Mix options combine three powerful income sources to give you the confidence to enjoy retirement. Each option is tailored to your Age Pension eligibility, ensuring you get the most from your super."
